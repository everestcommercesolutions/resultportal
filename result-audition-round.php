...
<html lan="en" oncontextmenu="return false;">
    ...
    <!-- Navbar-->
    <header role="header" class="header" style="background-color: #f9a821;">
                    ...
                    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav nav-dropdown " data-app-modern-menu="true">
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left page-scroll" href="auditionround">
                                    <span class="mbri-home mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span>Audition Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="performanceround">
                                    <span class="mbri-info mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span> Performance Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="grammarskillsround">
                                    <span class="mbri-contact-form mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span>Grammar Skills Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="espellbeecontest">
                                    <span class="mbri-contact-form mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span>eSpellBee Contest</a></li>
                            </ul>
                        </div>
                    </nav>
                </section>

				<div class="header__link1 retroNav col-lg-4" style="left: 18%;">
					<p style="font-family: Rajdhani,sans-serif;font-size: 15px;">
						<li class="alg"><a class="page-scroll "  href="auditionround"><span class="hvr-underline-from-left">Audition Round</span></a></li>
						<li class="alg"><a class="page-scroll" href="performanceround"><span class="hvr-underline-from-left">Performance Round</span></a></li>
					</p>
				</div>
				
				<div class="header__logo header__logo--home">
					<a href="https://www.espellbee.com">
						<img draggable="false" src="images/logo.png"  class="logo-img" style="height: 100px;">
					</a>
				</div>
				
				<div class="header__link2 retroNav col-lg-6">
					<p style="text-transform: lowercase; font-size: 13px;font-family: Rajdhani,sans-serif;font-size: 15px;">
						<li class="alg"><a href="grammarskillsround"><span class="hvr-underline-from-left">Grammar Skills Round</span></a></li>
						<li class="alg"><a href="espellbeecontest"><span class="hvr-underline-from-left" ><span style="text-transform:none;">eSpellBee</span> Contest</span></a></li>
					</p>
					<div class="navbar-custom-menu">
                        <ul class="top-nav">
	                        <li class="dropdown notification-menu" >
                                <a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
                                    <p class="tab blink"><b style="font-family: 'Montserrat', sans-serif;" class="gap-alert"><i class="fa fa-bell-o fa-lg"></i><span class="hvr-underline-from-left">  IMPORTANT ALERTS </span></b></p>
                                </a>
                                <ul class="dropdown-menu" style="background: #fff;padding-top: 0;padding-bottom: 0;">
                                    <li class="not-head">You have a Alert Message</li>       
                                    <li><a href="importantalerts" style="padding: 8px;height: 32px;"><i class="fa fa-hand-pointer-o"></i>  </a></li>     
                                </ul>
                            </li>
                        </ul>
                    </div>
    ...
    <style type="text/css">
        ...
        @media (max-width: 767px) and (min-width: 200px)
        {
            ...
            .fixed .header__logo, .fixed .header__logo.header__logo--home 
            {
                height: 131px;
                top: 14px;
                width:92px;
    ...
    <style type "text/css">
        ...
        .top-nav .notification-menu .not-head 
        {
            padding: 8px 0;
            text-align: center;
            font-weight: 500;
            background-color: rgba(252, 236, 195, 0.66);
            color: #333;
            font-family: 'Montserrat', sans-serif;
            font-weight: bold;
        }
 
        .top-nav .notification-menu .dropdown-menu 
        {
            min-width: 230px;
            margin-left: -84px;
        }
        ...
        .header__link1 a:after, .header__link2 a:after
        {
            visibility: hidden;
        }
		...
		<div class="wrapper">    
			<div class="content-wrapper" >
				...
				<div class="page-title">
					<div class="container" >
						<h1>Results of Audition Round</h1>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="navbaradd">              
							<button class="tablinks" onclick="audition(event, 'class1')" id="defaultOpen">Class 1</a>
							<button class="tablinks" onclick="audition(event, 'class2')">Class 2</a> 
							<button class="tablinks" onclick="audition(event, 'class3')">Class 3</a>	
							<button class="tablinks" onclick="audition(event, 'class4')">Class 4</a>	
							<button class="tablinks" onclick="audition(event, 'class5')">Class 5</a>	
							<button class="tablinks" onclick="audition(event, 'class6')">Class 6</a>	
							<button class="tablinks" onclick="audition(event, 'class7')">Class 7</a>	
							<button class="tablinks" onclick="audition(event, 'class8')">Class 8</a>	
							<button class="tablinks" onclick="audition(event, 'class9')">Class 9</a>	
							<button class="tablinks" onclick="audition(event, 'class10')">Class 10</a>	
							<button class="tablinks" onclick="audition(event, 'class11')">Class 11</a>	
							<button class="tablinks" onclick="audition(event, 'class12')">Class 12</a>	
						</div>
