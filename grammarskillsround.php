			...
			<div class="header__holder">
                    ...
                    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav nav-dropdown " data-app-modern-menu="true">
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left page-scroll" href="auditionround.php">
                                    <span class="mbri-home mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span>Audition Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="performanceround.php">
                                    <span class="mbri-info mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span> Performance Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="grammarskillsround.php">
                                    <span class="mbri-contact-form mbr-iconfont mbr-iconfont-btn" style="font-size: 15px;"></span>Grammar Skills Round</a></li>
                                <li class="nav-item"><a class="nav-link link text-white display-4 hvr-underline-from-left" href="espellbeecontest.php">
				...
				<div class="header__link1 retroNav col-lg-4" style="left: 18%;">
					<p style="font-family: Rajdhani,sans-serif;font-size: 15px;">
						<li class="alg"><a class="page-scroll "  href="auditionround.php"><span class="hvr-underline-from-left">Audition Round</span></a></li>
						<li class="alg"><a class="page-scroll" href="performanceround.php"><span class="hvr-underline-from-left">Performance Round</span></a></li>
					</p>
				</div>
				...
				<div class="header__link2 retroNav col-lg-6">
					<p style="text-transform: lowercase; font-size: 13px;font-family: Rajdhani,sans-serif;font-size: 15px;">
						<li class="alg"><a href="grammarskillsround.php"><span class="hvr-underline-from-left">Grammar Skills Round</span></a></li>
						<li class="alg"><a href="espellbeecontest.php"><span class="hvr-underline-from-left" ><span style="text-transform:none;">eSpellBee</span> Contest</span></a></li>
					</p>
				</div>
		...
		<div class="wrapper">    
			<div class="content-wrapper">
				...
				<div class="page-title">
					<div class="container">
						<h1>Results of Grammar Skills Round</h1>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="navbaradd">              
							<button class="tablinks" onclick="national(event, 'class1')" id="defaultOpen">Class 1</a>
							<button class="tablinks" onclick="national(event, 'class2')">Class 2</a> 
							<button class="tablinks" onclick="national(event, 'class3')">Class 3</a>	
							<button class="tablinks" onclick="national(event, 'class4')">Class 4</a>	
							<button class="tablinks" onclick="national(event, 'class5')">Class 5</a>	
							<button class="tablinks" onclick="national(event, 'class6')">Class 6</a>	
							<button class="tablinks" onclick="national(event, 'class7')">Class 7</a>	
							<button class="tablinks" onclick="national(event, 'class8')">Class 8</a>	
							<button class="tablinks" onclick="national(event, 'class9')">Class 9</a>	
							<button class="tablinks" onclick="national(event, 'class10')">Class 10</a>	
							<button class="tablinks" onclick="national(event, 'class11')">Class 11</a>	
							<button class="tablinks" onclick="national(event, 'class12')">Class 12</a>	
						</div>
						<div class="card">
							<div class="card-body">
